...
public class AppConfig {
    ...
    public RegisteredClientRepository registeredClientRepository(){
        ...
        RegisteredClient registeredClient1= getRegisteredClient("oauth2-client-app1", passwordEncoder.encode("secret1"), "read", "write");
        RegisteredClient registeredClient2= getRegisteredClient("oauth2-client-app2", passwordEncoder.encode("secret2"), "read", "delete");
        RegisteredClient registeredClient3= getRegisteredClient("oauth2-client-app3", passwordEncoder.encode("secret3"), "read", "update");
